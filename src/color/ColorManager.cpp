...
void ColorManager::createNames() {
    ...
    m_colorNames[BG] = (char*)"Background";
    m_colorNames[TEXT] = (char*)"Text";
    m_colorNames[BRUSH_UNSELECTED] = (char*)"Unbrushed Data";
    m_colorNames[BRUSH_BG1] = (char*)"Brushed Region";
    m_colorNames[BRUSH_SELECTED1] = (char*)"Brushed Data";
    m_colorNames[GRID1] = (char*)"Grid/Axis 1";
    m_colorNames[GRID2] = (char*)"Grid/Axis 2";
    m_colorNames[GRID3] = (char*)"Grid/Axis 3";
    m_colorNames[PIXEL_HIGHLIGHT] = (char*)"Pixel-Oriented Dim Highlight";
    m_colorNames[MARKER_UNSELECTED] = (char*)"Unselected Marker";
    m_colorNames[MARKER_SELECTED] = (char*)"Selected Marker";

	// PREDEFINED COLOR MAPS
	m_predefinedColorRampNames.resize(TOTAL_RAMPS);
    m_predefinedColorRampNames[SEQ_ORANGES] = (char*)"Oranges";
    m_predefinedColorRampNames[SEQ_GRAYSCALE] = (char*)"Grayscale";
    m_predefinedColorRampNames[SEQ_YLORRD] = (char*)"Yellow, Orange, Red";
    m_predefinedColorRampNames[SEQ_YLGNBU] = (char*)"Yellow, Green, Blue";
    m_predefinedColorRampNames[SEQ_PURD] = (char*)"Purple, Red";
    m_predefinedColorRampNames[SEQ_NOYELLOW] = (char*)"No Yellow";
    m_predefinedColorRampNames[SEQ_HSIFULL] = (char*)"All Colors";
    m_predefinedColorRampNames[DIV_RDBU] = (char*)"Red, Blue";
    m_predefinedColorRampNames[DIV_PUOR] = (char*)"Purple, Orange";
    m_predefinedColorRampNames[DIV_RDYLGN] = (char*)"Red, Yellow, Green";
    m_predefinedColorRampNames[DIV_SPECTRAL] = (char*)"Spectral";
    m_predefinedColorRampNames[DIV_RDGY] = (char*)"Red, Gray";
    m_predefinedColorRampNames[DIV_PUGN] = (char*)"Purple, Green";
    m_predefinedColorRampNames[QUAL_SET1] = (char*)"Set 1";
    m_predefinedColorRampNames[QUAL_SET2] = (char*)"Set 2 Pastel";
    m_predefinedColorRampNames[QUAL_PASTEL] = (char*)"Set 1 Pastel";
    m_predefinedColorRampNames[QUAL_DARK] = (char*)"Set 2";
    m_predefinedColorRampNames[QUAL_ACCENTS] = (char*)"Accents";
    m_predefinedColorRampNames[LINK_REL2_RD] = (char*)"Red";
    m_predefinedColorRampNames[LINK_REL2_GN] = (char*)"Green";
    m_predefinedColorRampNames[LINK_REL2_BU] = (char*)"Blue";
    m_predefinedColorRampNames[LINK_CON2_BLWH] = (char*)"Black, White";
    m_predefinedColorRampNames[LINK_CON2_RDGN] = (char*)"Red, Green";
    m_predefinedColorRampNames[LINK_REL5_RD] = (char*)"Red";
    m_predefinedColorRampNames[LINK_REL5_GN] = (char*)"Green";

	// THEME NAMES
	m_themeNames.resize(TOTAL_THEMES);
    m_themeNames[DEFAULT] = (char*)"Default";
    m_themeNames[NOCTURNAL] = (char*)"Nocturnal";
}

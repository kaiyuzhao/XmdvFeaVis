...
#include "operator/dimreduct/DimClusterViewOperator.h"
#include "operator/dimreduct/DimRdctClustViewOperator.h"
...
int PipelineManager::createDimRPipeline(OkcData* origData) {
    ...
    //create an instance of DimClusterViewOperator;
    DimClusterViewOperator* dimClustQ = new DimClusterViewOperator();

    //create an instance of DimRdctClustViewOperator
    DimRdctClustViewOperator* drClustView = new DimRdctClustViewOperator();
    ...
    operatorArr[PL_DIMR_OP_DIMCLUST] = dimClustQ;
    operatorArr[PL_DIMR_OP_DRCLSTVIEW] = drClustView;
    ...
    newline->m_mainTransformation->setOperators(PL_DIMR_OP_CNT, operatorArr); //set count
	delete []operatorArr;
    ...
    this->addOperator((Operator*)dimClustQ);
    this->addOperator((Operator*)drClustView);
	this->addOperator((Operator*)dimoooQ);
	this->addOperator((Operator*)brushQ);
	this->addOperator((Operator*)histogramQ);
	this->addOperator((Operator*)sortRowAllDimQ);
	...
	ScatterVisAttr* scatterVisAttr = new ScatterVisAttr();
	newVisualMap->setScatterVisAttr(scatterVisAttr);
    qDebug()<<"pipeline manager createDimRPipeline()\n";
	return pipelineID;

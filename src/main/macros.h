...
////////////////////////////////////////////////////////////////////
// The number of operators
// in XMDV_R version, this operator list is extended
// We need multiple strategies to reduce the number of dimensions;
#define PL_DIMR_OP_CNT 8 //total number of operators;

#define PL_DIMR_OP_DIMTREE 0 // The index of DimTreeOperator

#define PL_DIMR_OP_DRVIEW 1 // The index of DimReductViewOperator

#define PL_DIMR_OP_DIMCLUST 2 // The index of DimClusterViewOperator

#define PL_DIMR_OP_DRCLSTVIEW 3 //The index of DimRdctClustViewOperator

#define PL_DIMR_OP_DIMOOO 4 // The index of DimOOOOperator

#define PL_DIMR_OP_BRUSH 5 // The order of BrushOperator

#define PL_DIMR_OP_HISTOGRAM 6 // The order of HistogramOperator

#define PL_DIMR_OP_SORTROWALLDIM 7 // The order of RowIndexOnAllDimOperator
...
// Icon for correlation map
#define ICON_CR QIcon(QString::fromUtf8(":/new/prefix3/icon/resize.png"))
//
#endif /*MACROS_H_*/
